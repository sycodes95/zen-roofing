    ...
    <main className="relative flex flex-col w-full h-full grow">
      ...
      <div className='z-10 flex w-full pt-24 pb-24 bg-opacity-50 h-fit'>
        <div className='flex flex-col items-start justify-center w-1/2 h-full gap-8 text-2xl text-black '>
          ...
          <div className='flex flex-col p-2 pl-4 pr-4 bg-black border-l-2 border-orange-600 h-fit bg-opacity-20 w-fit backdrop-blur-sm'>
          ...
          <button className='p-3 pl-10 pr-10 text-sm font-bold text-white transition-colors duration-500 bg-zinc-900 hover:bg-orange-600 '>Learn More +</button>
        </div>
