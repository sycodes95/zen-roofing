  ...
  return (
    <main className=" flex flex-col w-full h-full grow">
      ...
      <div className='z-10 flex w-full pt-24 pb-24 bg-opacity-50 h-fit '>
        <div className='flex flex-col items-start justify-center h-full gap-8 text-2xl text-black p-4 pt-8 pb-8 md:p-12 bg-white rounded-lg w-fit bg-opacity-70 border border-white border-l-8 border-r-8'>
