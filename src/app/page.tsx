...
export default function Home() {
  return (
    <main className=" flex flex-col w-full h-full grow">
      <div className='absolute top-16 left-0 h-[800px] w-full bg-emerald-500 bg-opacity-20 -z-10'></div>
      ...
      <div className='z-10 flex w-full pt-24 pb-24 bg-opacity-50 h-fit '>
        <div className='flex flex-col items-start justify-center h-full gap-8 text-2xl text-black p-12 bg-white rounded-lg w-fit bg-opacity-50 border border-white border-l-8 border-r-8'>
