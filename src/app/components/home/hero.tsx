  ...
  return (
    <div className='flex flex-col items-start justify-center h-full text-2xl text-black   rounded-xl w-fit   '>
      <div className=' backdrop-blur-sm p-4 rounded-xl rounded-bl-none'>
        <div className='flex flex-col gap-4 rounded-xl  text-white'>
          <span className='text-4xl md:text-6xl text-left max-w-xl mt-1 font-inter-tight-display'>Peak performance for your roof.</span>
      ...
      <div className=' backdrop-blur-sm p-4 rounded-xl -t-0 rounded-bl-none rounded-tl-none  bg-opacity-70 rounded-tr-none'>
